...
p5.prototype.createStereoCanvas = function(renderer, _width=windowWidth, _height=windowHeight, eyeBuffer){
  ...
  var canvas = createCanvas(_width, _height, renderer)
  ...
  document.getElementById('canvases').appendChild(_duplicateCanvas);
  ...
  //dc.style.top = 0;
  dc.style.left =  (_originalCanvas.style.width/2) + eyeBuffer*2;
  dc.style.width = _originalCanvas.style.width;
  dc.style.height = _originalCanvas.style.height;
